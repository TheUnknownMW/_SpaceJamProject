            ...
            <div class="orbit" role="region" aria-label="Favorite Space Pictures" data-orbit>
                  <ul class="orbit-container">
                    ...
                    <li class="orbit-slide">
                      <img class="orbit-image" src="images/cloth-1/1.png" alt="Space">
                    </li>
                    <li class="orbit-slide">
                      <img class="orbit-image" src="images/cloth-1/2.png" alt="Space">
                    </li>
                    <li class="orbit-slide">
                      <img class="orbit-image" src="images/cloth-1/3.png" alt="Space">
                    </li>
                  </ul>
