            ...
            <div class="orbit" role="region" aria-label="Favorite Space Pictures" data-orbit>
                  <ul class="orbit-container">
                    ...
                    <li class="orbit-slide">
                      <img class="orbit-image" src="images/cloth-3/1.jpg" alt="Space" style="height: 400px;">
                    </li>
                    <li class="orbit-slide">
                      <img class="orbit-image" src="images/cloth-3/2.png" alt="Space" style="height: 400px;">
                    </li>
                    <li class="orbit-slide">
                      <img class="orbit-image" src="images/cloth-3/3.png" alt="Space" style="height: 400px;">
                    </li>
                  </ul>
